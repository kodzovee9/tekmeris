...
The toolkit and the computations reported here were prepared with
extensive use of a large language model (Anthropic's Claude) for code
generation, document parsing, and diagnosis. No AI-generated number
