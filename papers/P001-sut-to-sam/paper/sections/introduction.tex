...
edits are likewise isolated and bounded.
...
Our contribution is therefore not a new balancing estimator---the
mathematics of biproportional (RAS) and cross-entropy adjustment is settled
\citep{robinson2001,temurshoev2013}---but a demonstration, on a full-scale
