...
from edikit.pipeline.eurostat_sam import balance, generate, write_balanced_csv  # noqa: E402
...
def main() -> None:
    ...
    with open(OUT / "netherlands_generation.md", "w") as f:
        f.write(f"# Netherlands: benchmark-free macro-SAM generation\n\n"
                f"Generated by code/15_netherlands_generate.py from "
    ...
    write_balanced_csv(bal, OUT / "netherlands_macro_sam_balanced.csv")
