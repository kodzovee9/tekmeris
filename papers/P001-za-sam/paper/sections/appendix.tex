...
inputs needed to decide are unavailable).
...
Household grouping variable & two dictionary-free anchors &
unique within tested definitions \\
...
alternative would be GRAS; normalisation is preferred because it makes
the negativity explicit and reviewable rather than absorbing it into a
...
The toolkit (\texttt{edikit}, Apache-2.0) is a small Python library in
four modules---\texttt{data} (readers for supply--use workbooks, SAM
