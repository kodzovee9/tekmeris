...
and the Netherlands --- working paper, draft v0.5}
...
\citet{vanseventer2023}: the benchmark's production, commodity, and
institutional macro structure is reproduced exactly up to one unpublished
input, which is separately identified and priced ($+16.1$ per cent on
import duties under its public proxy). Where the benchmark's choices are
