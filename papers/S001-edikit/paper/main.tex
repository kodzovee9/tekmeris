...
\begin{description}
  ...
  (\texttt{pip install edikit==0.2.4}). The repository remains the route
  ...
  \texttt{toolkit/}); licence Apache-2.0; version 0.2.4, July 2026.
...
Reusers should know the current limitations plainly. Version 0.2.4
...
Natural extensions, deliberately scoped out of version 0.2.4, include
