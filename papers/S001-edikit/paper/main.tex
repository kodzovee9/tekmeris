...
test runs from inputs shipped in the archive, so a reviewer sees
\texttt{38 passed}. Line
...
\begin{description}
  ...
  \texttt{toolkit/}); licence Apache-2.0; version 0.2.3, July 2026.
  \item[Archive:] Zenodo, DOI
  \href{https://doi.org/10.5281/zenodo.21473805}{10.5281/zenodo.21473805}
  (version v0.2.3; concept DOI for all versions:
...
Reusers should know the current limitations plainly. Version 0.2.3
...
Natural extensions, deliberately scoped out of version 0.2.3, include
...
doi:10.5281/zenodo.21473805. Third-party inputs whose licences do not permit
