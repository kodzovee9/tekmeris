...
\author{Kodzovi Abalo\thanks{World Bank; ORCID
0000-0002-7567-2181. The views expressed here are those of the author
and do not necessarily reflect the views of the World Bank, its
...
constitutes the record. The toolkit was developed for, and validated across,
five countries and three exercise types: a cell-level reconstruction
and audit of the
...
record. The
recipes are thin by design: the same functionality is a five-line
library call, e.g.
...
| lab | -4,193 | -0.578% |    | row | -10,830 | -1.494% |
...
Windows across Pythons 3.11--3.13 on every push. Beyond the five
...
cells exact, the remaining two differing by a documented R596m
reconciling adjustment; the benchmark's single unpublished input
separately priced \\
...
\begin{description}
  ...
  \texttt{toolkit/}); licence Apache-2.0; version 0.1.3, July 2026.
  \item[Archive:] Zenodo, DOI
  \href{https://doi.org/10.5281/zenodo.21425326}{10.5281/zenodo.21425326}
  (version v0.1.3; concept DOI for all versions:
...
Reusers should know the current limitations plainly. Version 0.1.3
...
Natural extensions, deliberately scoped out of version 0.1.3, include
...
reports, and generated outputs are archived with the software deposit
identified above. Third-party inputs whose licences do not permit
...
No dedicated funding. The views expressed are the author's alone.
